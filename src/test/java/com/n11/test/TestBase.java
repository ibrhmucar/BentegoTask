...
public class TestBase {
    ...
    public void setUpTest() throws IOException {
        ...
        //title in report
        htmlReporter.config().setReportName("bentego Smoke Test");
        ...
        extentLogger = report.createTest("Bentego Task");
    ...
    public void tearDown(ITestResult result) throws Exception {
        ...
        if(result.getStatus()==ITestResult.FAILURE){
            ...
            report.createTest("Failed Step").fail("Failed").fail(result.getName()).addScreenCaptureFromBase64String(failed);
